                        ...
                        <tbody>
                            @foreach($schedules as $schedule)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $schedule->bookings_count >= $schedule->max_quota ? 'bg-danger' : 'bg-success' }}">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary btn-edit" data-bs-toggle="modal"
                                            ...
                                            data-schedule="{{ $schedule->toJson() }}" data-trainer-id="{{ $schedule->trainer_id }}">
                                            <i class="bi bi-pencil-fill"></i>
                                        </button>
                                        <form action="{{ route('admin.schedules.destroy', $schedule->id) }}" method="POST"
                                            class="d-inline" onsubmit="return confirm('Anda yakin ingin menghapus jadwal ini?');">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <div class="card-body p-3">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <div>
                                        <h6 class="mb-1 fw-semibold">
                                            {{ $schedule->custom_class_name ?? $schedule->classList->name ?? 'N/A' }}</h6>
                                        <small class="text-muted">{{ $schedule->type }}</small>
                                    </div>
                                    <span
                                        class="badge {{ $schedule->bookings_count >= $schedule->max_quota ? 'bg-danger' : 'bg-success' }}">
                                ...
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <span class="small fw-semibold">{{ $schedule->start_time->format('H:i') }} -
                                            {{ $schedule->end_time->format('H:i') }}</span>
                                    </div>
                                    <div class="col-12">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary flex-grow-1 btn-edit" data-bs-toggle="modal"
                                        data-bs-target="#editScheduleModal" data-id="{{ $schedule->id }}"
                                        data-action="{{ route('admin.schedules.update', $schedule->id) }}"
                                        data-schedule="{{ $schedule->toJson() }}" data-trainer-id="{{ $schedule->trainer_id }}">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select @error('class_list_id') is-invalid @enderror"
                                    id="add_class_list_id" name="class_list_id" required>
                                    ...
                                    @endforeach
                                    <option value="other" {{ old('class_list_id') == 'other' ? 'selected' : '' }}>Other
                                        (Specify New Class)</option>
                                </select>
                                @error('class_list_id')
                            ...
                            <div class="col-12" id="add_custom_class_name_group" style="display: none;">
                                ...
                                <input type="text" class="form-control @error('custom_class_name') is-invalid @enderror"
                                    id="add_custom_class_name" name="custom_class_name"
                                    value="{{ old('custom_class_name') }}" placeholder="Enter new class name">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="form-select @error('day') is-invalid @enderror" id="add_day" name="day"
                                    required>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" id="add_type" name="type"
                                    required>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="time" class="form-control @error('start_time') is-invalid @enderror"
                                    id="add_start_time" name="start_time" value="{{ old('start_time') }}" required>
                                @error('start_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="time" class="form-control @error('end_time') is-invalid @enderror"
                                    id="add_end_time" name="end_time" value="{{ old('end_time') }}" required>
                                @error('end_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="form-select @error('trainer_id') is-invalid @enderror" id="add_trainer_id"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="number" class="form-control @error('max_quota') is-invalid @enderror"
                                    id="add_max_quota" name="max_quota" value="{{ old('max_quota') }}" min="1" required>
                                @error('max_quota')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                    id="add_description" name="description" rows="3">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select @error('class_list_id') is-invalid @enderror"
                                    id="edit_class_list_id" name="class_list_id" required>
                                    <option value="" disabled selected>Pilih nama kelas...</option>
                                    @foreach($classLists as $classList)
                            ...
                            <div class="col-12" id="edit_custom_class_name_group" style="display: none;">
                                ...
                                <input type="text" class="form-control @error('custom_class_name') is-invalid @enderror"
                                    id="edit_custom_class_name" name="custom_class_name" placeholder="Enter new class name">
                                @error('custom_class_name')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="number" class="form-control" id="edit_max_quota" name="max_quota" min="1"
                                    required>
                            </div>
