                        ...
                        <div class="card border-0 shadow-sm" style="background-color: #f8f9fa;">
                             <div class="card-body p-4">
                                ...
                                <div class="alert alert-info border-0 bg-white shadow-sm">
                                    <p class="fw-bold mb-1">Bank BCA: 4400304870</p>
                                    <p class="fw-bold mb-1">Bank Mandiri: 078430044</p>
                                    <p class="mb-0">a/n Aang Ghunaifi Dardiri</p>
                                </div>
                                <hr>
                                ...
                                <ul class="list-unstyled text-muted small">
                                    ...
                                    <li class="mb-2"><i class="bi bi-5-circle-fill me-2 text-primary"></i> Proses validasi pembayaran dilakukan sesuai jam operasional Grit Fitness (06.00 - 22.00 WIB)</li>
                                </ul>
                             </div>
                        </div>
                    </div>
