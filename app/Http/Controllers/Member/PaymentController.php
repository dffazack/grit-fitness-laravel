...
class PaymentController extends Controller
{
    ...
    public function updatePhoneQuick(\Illuminate\Http\Request $request)
    {
        $request->validate([
        ...
        // Redirect KEMBALI ke halaman payment
        return redirect()->route('member.payment')
            ->with('success', 'Nomor WhatsApp berhasil disimpan. Silakan lanjutkan pembayaran.');
    }
}
