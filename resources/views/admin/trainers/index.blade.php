            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                <div class="card h-100 border-0 shadow-sm hover-card">
                    <div class="card-body d-flex flex-column text-center p-3 p-md-4">
                        ...
                        {{-- Foto Trainer --}}
                        <img src="{{ asset('storage/' . $trainer->image) }}" class="rounded-circle mx-auto mb-3"
                            alt="{{ $trainer->name }}"
                    ...
                    <div class="modal-body p-3 p-md-4">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="number" class="form-control" id="add_experience" name="experience"
                                    value="{{ old('experience') }}" min="0" required>
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="add_clients" class="form-label">Jumlah Klien (Opsional)</label>
                                <input type="text" class="form-control" id="add_clients" name="clients"
                                    value="{{ old('clients') }}" placeholder="Contoh: 150+">
                            </div>
                            <div class="col-12">
                                <label for="add_certifications" class="form-label">Sertifikasi (Pisahkan dengan
                                    koma)</label>
                                <input type="text" class="form-control" id="add_certifications" name="certifications"
                                    value="{{ old('certifications') }}" placeholder="Contoh: ACE, RYT-200">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="file"
                                    ...
                                    id="add_image" name="image" accept=".png,.jpg,.jpeg">
                                <small class="form-text text-muted">Hanya PNG/JPG/JPEG, maksimal 2MB.</small>
                                @if($isInvalid)
                                <div class="invalid-feedback">{{ $errors->first('image') }}</div>@endif
                            </div>
                            <div class="col-12">
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="edit_name_{{ $trainer->id }}" name="name" value="{{ old('name', $trainer->name) }}"
                                        required>
                                    @error('name')
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('specialization') is-invalid @enderror"
                                        id="edit_specialization_{{ $trainer->id }}" name="specialization"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="edit_email_{{ $trainer->id }}" name="email"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="tel" class="form-control @error('phone') is-invalid @enderror"
                                        id="edit_phone_{{ $trainer->id }}" name="phone"
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="edit_experience_{{ $trainer->id }}" class="form-label">Pengalaman
                                        (Tahun)</label>
                                    <input type="number" class="form-control @error('experience') is-invalid @enderror"
                                        id="edit_experience_{{ $trainer->id }}" name="experience"
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="edit_clients_{{ $trainer->id }}" class="form-label">Jumlah Klien
                                        (Opsional)</label>
                                    <input type="text" class="form-control @error('clients') is-invalid @enderror"
                                        id="edit_clients_{{ $trainer->id }}" name="clients"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('bio') is-invalid @enderror"
                                        id="edit_bio_{{ $trainer->id }}" name="bio"
                                ...
                                <div class="col-12">
                                    <label for="edit_image_{{ $trainer->id }}" class="form-label">Ganti Foto Trainer
                                        (Opsional)</label>
                                    <input type="file"
                                        class="form-control @error('image') is-invalid @enderror image-upload-input"
                                        id="edit_image_{{ $trainer->id }}" name="image" accept=".png,.jpg">
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            id="edit_is_active_{{ $trainer->id }}" name="is_active" value="1" {{ (old('is_active', $trainer->is_active) == 1) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="edit_is_active_{{ $trainer->id }}">Status
                                            Aktif</label>
                                    </div>
                                </div>
                            </div>
