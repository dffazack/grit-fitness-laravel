        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                ...
                <div class="d-flex align-items-center">
                    ...
                    @elseauth('web')
                        {{-- 2. Member sudah login – VERSI CENTERED (tengah layar) --}}
                        <div class="dropdown">
                            <button class="btn border-0 p-0 rounded-circle" type="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="rounded-circle d-flex align-items-center justify-content-center"
                                    style="width: 40px; height: 40px; background-color: var(--grit-primary); color: white;">
                                    <i class="bi bi-person-fill fs-5"></i>
                                </div>
                            </button>

                            {{-- Dropdown muncul di TENGAH LAYAR --}}
                            <ul class="dropdown-menu shadow-lg border-0 rounded-3"
                                ...
                                <div class="text-center py-3 border-bottom">
                                    <div class="rounded-circle mx-auto mb-2 d-flex align-items-center justify-content-center"
                                        style="width: 60px; height: 60px; background-color: var(--grit-primary); color: white;">
                                        <i class="bi bi-person-fill fs-3"></i>
                                    </div>
                                    <h6 class="mb-0 fw-bold">Menu Saya</h6>
                                </div>

                                <li><a class="dropdown-item py-3" href="{{ $dashboardRoute }}">
                                ...
                                <li>
                                    <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                        @csrf
                                        <button type="submit" class="dropdown-item py-3 text-danger">
